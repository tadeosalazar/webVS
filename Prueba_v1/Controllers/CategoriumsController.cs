...
namespace Prueba_v1.Controllers
{
    ...
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(Pia_ProgWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'Pia_ProgWebContext.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,Nombre,Descripción")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,Nombre,Descripción")] Categorium categorium)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Pia_ProgWebContext.Categoria'  is null.");
            }
            var categorium = await _context.Categoria.FindAsync(id);
            if (categorium != null)
            {
